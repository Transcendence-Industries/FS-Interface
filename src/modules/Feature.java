...
/**
 * Template row describing one simulator <-> hardware binding.
 * type: 0 = simulator -> hardware (output), 1 = hardware -> simulator (input)
 */
public class Feature {
    ...
    public boolean checkConfiguration() {
        // Basic validation used by the GUI before activation.
